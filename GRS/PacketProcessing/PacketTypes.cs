...
namespace CRS.PacketProcessing
{
	...
	{
		// Token: 0x06000304 RID: 772 RVA: 0x00016EDC File Offset: 0x000150DC
		...
		// Token: 0x06000305 RID: 773 RVA: 0x00016F14 File Offset: 0x00015114
		...
		{
			{ 120, "NextCardCommand" },
			{ 500, "EditCardPositionCommand" },
			{ 502, "StartCrownChestCommand" },
			{ 537, "SearchOppenentCommand" },
			{ 506, "UnlockChestCommand" },
			{ 516, "LevelUpCommand" },
			{ 528, "BuyChestCommand" },
			{ 530, "BuyCardCommand" },
			{ 535, "ClaimAchievementCommand" },
			{ 536, "TvReplaySeenCommand" },
			{ 538, "ChestNextCardCommand" },
			{ 10100, "ClientHello" },
			{ 10101, "Login" },
